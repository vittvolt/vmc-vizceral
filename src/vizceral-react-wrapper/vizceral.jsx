...
class Vizceral extends React.Component {
  ...
  componentWillReceiveProps (nextProps) {
    ...
    // DEBUG
    // let info = 'nextProps: ' + nextProps.traffic.updated + ' now(): ' + Date.now()
    //            + ' prev: ' + this.props.traffic.updated;
    // alert(info)
    ...
    if (!this.props.traffic.nodes
      ...
      || (nextProps.traffic.secret && nextProps.traffic.secret === 3)) {
      nextProps.traffic.secret = 0; // I know this is hacky, but...
